        ...
        <header className="bg-white shadow-sm">
            <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
                ...
                <div className="flex items-center space-x-4">
                    <a href="https://github.com/NithinIBhandari1999/groq-text-to-speech" className="px-4 py-2 text-sm bg-gray-800 text-white border border-gray-300 rounded shadow-sm hover:bg-gray-700">
                        Github
                    </a>
                    {/*
